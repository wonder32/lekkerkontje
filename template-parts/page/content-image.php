...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	$style   = 'background-image: url("' . $img_src[0] . '");background-repeat: no-repeat;background-size:cover;background-position: center ' . $focus . ';';
    ...
    <div class="entry-content l-container">
        ...
        <div class="image-content l-col-6">
            <div class="attachment-block orientation-<?php echo $class; ?>" style='<?php echo $style; ?>'
                 id="image-frame">
                <div id="attachment-rating">
                </div>
                <div class="attachment-controls">
                    <div class="attachment-previous"><a href="<?php echo $lekkerKontje->getNext(); ?>"><span
                                    class="dashicons dashicons-arrow-right-alt"></span></a></div>
                    ...
                    <div class="attachment-next"><a href="<?php echo $lekkerKontje->getPrevious(); ?>"><span
                                    class="dashicons dashicons-arrow-left-alt"></span></a></div>
                </div>
            </div>
        </div>
        <div class="image-decription l-col-6">
			...
			<?php the_title( '<h1 class="entry-title" id="entry-title">', '</h1>' ); ?>
            ...
            <div class="entry-meta">
                <div class=" l-col-6">
					...
					?>
                    <img src="<?= $thumb_src[0]; ?>" alt="<?= $lekkerKontje->getTag(); ?>">
                </div>
                <div class=" l-col-6">
